  ...
  render() {
    return (
      <footer>
        ...
        <Link to="/create-program"><i style={{color:(window.location.pathname==='/create-program' ? '#EC963A':'#F5F9FF'),'marginLeft': '20px', 'marginRight': '20px'}}className="material-icons">description</i></Link>
