  ...
  render() {
    return (
      <footer>
        ...
        <Link to="/userprofile"><i style={{color:(window.location.pathname==='/userprofile' ? '#EC963A':'#F5F9FF'),'marginLeft': '20px', 'marginRight': '20px'}}className="material-icons">account_circle</i></Link>
